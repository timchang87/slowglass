...
| <a name="input_common_tags"></a> [common\_tags](#input\_common\_tags) | Common tags to apply to all resources | `map(string)` | <pre>{<br/>  "Environment": "staging",<br/>  "ManagedBy": "Terraform",<br/>  "Project": "refresh"<br/>}</pre> | no |
...
| <a name="input_personal_public_ip"></a> [personal\_public\_ip](#input\_personal\_public\_ip) | Your personal public IP address for secure access | `string` | `"192.168.1.1/32"` | no |
